...
<div class="w3-content w3-section" style="max-height:500px">
  <img class="mySlides" src="images/bg-01.jpg" style="width:100%">
  <img class="mySlides" src="images/bg-02.jpg" style="width:100%">
  <img class="mySlides" src="images/bg-03.jpg" style="width:100%">
</div>
-->


<!-- Main Body -->
<div class="w3-row" style="background: linear-gradient(to left, #33ccff -30%, #990000 149%);
">
  ...
  <div class="w3-col m6 w3-center"><p></p>
  	<form class="w3-container w3-center" action="index.php" method="POST">
		...
		<label class="w3-text-brown"><p><b>Search</b></p></label>
		<p><select name="searchfield">
...
<div class="w3-container" style="background: linear-gradient(to left, #33ccff -30%, #990000 149%);
">
	<?php
	if($SEARCH == "myprojects"){
		if(empty($projects)){
